  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col bg-white">
            ...
            <div className="flex items-center gap-1.5">
              {steps.map((s, i) => (
                <div key={s.id} className="flex items-center gap-1.5">
                  ...
                  {i < steps.length - 1 && (
                    <div className={`h-0.5 w-4 sm:w-8 xl:w-12 rounded-full transition-all ${i < currentIndex ? 'bg-primary' : 'bg-slate-100'}`} />
                  )}
                </div>
              ))}
            </div>
        ...
        {/* Form content */}
        <div className="flex-1 flex items-start justify-center px-4 sm:px-8 pt-10 pb-8 overflow-y-auto">
          <div className="w-full max-w-md">
