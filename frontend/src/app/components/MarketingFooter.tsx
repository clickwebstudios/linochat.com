        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/resources#blog" className="hover:text-primary transition-colors">Blog</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/resources#docs" className="hover:text-primary transition-colors">Documentation</Link></li>
              <li><a href="mailto:support@linochat.com" className="hover:text-primary transition-colors flex items-center gap-1">
