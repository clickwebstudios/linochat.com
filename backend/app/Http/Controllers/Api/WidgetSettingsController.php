...
class WidgetSettingsController extends Controller
{
    ...
    public function update(Request $request, string $project_id)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'popover.overlay'                      => 'nullable|string|in:dark,light,none',
            'popover.overlay_blur'                 => 'nullable|boolean',
            ...
            'popover.max_displays_per_session'      => 'nullable|integer|min:0|max:100',
            'popover.primary_button.icon'           => 'nullable|string|max:4',
            'popover.secondary_button.icon'         => 'nullable|string|max:4',
